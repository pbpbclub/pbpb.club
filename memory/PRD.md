...
### Phase 5 - Estimate Creation Page (Completed ✅) - December 2025
**New `/orders/:orderId/estimate` Page:**
- Теги этапов производства (Сварка, Покраска, Столярка, Обивка, Сборка, Доставка, Монтаж)
- Раздел "Виды работ" с типом, названием, количеством, единицей, ценой, сроком
- Раздел "Материалы" с выбором из каталога
- Раздел "Дополнительные расходы"
- Настройки расчёта:
  - Безналичный расчёт (+14%)
  - Издержки (% от суммы)
  - Маржа (% наценки)
- Автоматическая калькуляция:
  - Подитог (работы + материалы + доп.расходы)
  - Себестоимость (подитог + издержки)
  - Цена для заказчика (себестоимость + маржа + безнал)
  - Прибыль и рентабельность
- Карточка "Смета" на странице заказа теперь кликабельная
