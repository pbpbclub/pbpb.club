...
const statusColors = {
  ...
  project: 'bg-blue-100 text-[#384E84] border-blue-300',
  estimation: 'bg-orange-100 text-[#E26A2D] border-orange-300',
  production: 'bg-blue-100 text-[#384E84] border-blue-300',
