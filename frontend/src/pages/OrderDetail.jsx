  ...
  return (
    <div className="p-8">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-900">Клиент: {order.client}</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        <Card className="border-gray-300 shadow-sm">
          <CardContent className="p-6">
            <div className="text-xs text-gray-900 uppercase tracking-wider mb-2">
              Себестоимость
            </div>
          ...
          order.stages.map((stage) => (
            <Card key={stage.id} className="border-gray-300 shadow-sm">
              <CardHeader className="pb-3">
                ...
                {stage.master && (
                  <p className="text-sm text-gray-900">Мастер: {stage.master}</p>
                )}
              </CardHeader>
              <CardContent>
